//Cohesion The extent to which the code for a class represents a single abstraction.
//coupling, the degree to which one part of a program depends on another.
//Each card is called a CRC card and lists the Class, its Responsibilities, and its Collaborators (other classes to which it is coupled).
//
public class Stock {
